...
export function GlobalContextProvider(props) {
    const [globals, setGlobals] = useState({ aString: 'init val', count: 0, hideHamMenu: true, clients: [], dataLoaded: false })
    ...
    async function getAllClients() {
        ...
        setGlobals((previousGlobals) => { const newGlobals = JSON.parse(JSON.stringify(previousGlobals)); newGlobals.clients = data.clients; newGlobals.dataLoaded = true; return newGlobals })
    }
